...
window = eg.Window(
    ...
    layout=[
        ...
        [
            eg.Radio("Radio1", group_id="abc", key="-radio1-", enable_events=True),
            eg.Radio(
                "Radio2",
                group_id="abc",
                key="-radio2-",
        ...
        [
            eg.Checkbox("Checkbox", key="-checkbox-", enable_events=True),
            eg.Button("Change", key="-checkbox-button-"),
        ],
        [
            eg.Combo(
            ...
            eg.Button("Change", key="-combo-button-"),
        ],
        [
            eg.Button("Exit"),
            eg.Button("Maximize"),
